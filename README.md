...
1. Connect to the Snowflake database.
2. Execute each SQL script (`01_data_overview.sql`, `02_temporal_trends.sql`, etc.) in sequence.
3. Review the results and visualizations generated by the queries.
